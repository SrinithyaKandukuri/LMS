...
<%
    ...
    try {
        ...
        ps = conn.prepareStatement("SELECT * FROM REGISTERLIB WHERE email = ?");
        ...
        if (rs.next()) {
            ...
            ps = conn.prepareStatement("SELECT * FROM REGISTERLIB WHERE username = ?");
            ...
            ps = conn.prepareStatement("insert into REGISTERLIB values(?,?,?,?,?)");
